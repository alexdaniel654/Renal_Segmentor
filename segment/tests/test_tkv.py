...
class TestTkv:
    ...
    @pytest.mark.parametrize('path, expected, expected_prob, '
        ...
        (fetch.Sub1('PAR').path,
         [0.035514, 0.185075, 1, 0, 13, 0],
         [0.035452, 0.182477, 1, 0, 13, 0],
         [0.035487, 0.185008, 1, 0, 13, 0],
         310.6836),
        (fetch.Sub1('PAR').img,
         [0.035514, 0.185075, 1, 0, 13, 0],
         [0.035452, 0.182477, 1, 0, 13, 0],
        ...
        (nib.Nifti1Image(fetch.Sub1('nii.gz').img.get_fdata(),
         ...
         310.6836),
        (fetch.Sub2('PAR').path,
         [0.01653, 0.127501, 1, 0, 17, 0],
         [0.016529, 0.126849, 1, 0, 17, 0],
         [0.01646, 0.127235, 1, 0, 17, 0],
         226.93275),
        (fetch.Sub2('PAR').img,
         [0.01653, 0.127501, 1, 0, 17, 0],
         [0.016529, 0.126849, 1, 0, 17, 0],
